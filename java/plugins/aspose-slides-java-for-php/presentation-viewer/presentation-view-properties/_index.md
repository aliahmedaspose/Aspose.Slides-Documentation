...
try {
    $pres->getViewProperties()->getNormalViewProperties()->setHorizontalBarState(Java("com.aspose.slides.SplitterBarStateType")->Restored);
    $pres->getViewProperties()->getNormalViewProperties()->setVerticalBarState(Java("com.aspose.slides.SplitterBarStateType")->Maximized);
